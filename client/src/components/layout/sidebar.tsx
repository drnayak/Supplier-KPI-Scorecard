...
const navigation = [
  ...
  },
  {
    section: "History",
    items: [
      { name: "Price History", href: "/price-evaluations", icon: DollarSign },
      { name: "Quantity History", href: "/quantity-evaluations", icon: Package },
      { name: "Delivery History", href: "/delivery-evaluations", icon: Clock },
      { name: "Quality History", href: "/quality-evaluations", icon: AlertTriangle },
      { name: "PPM History", href: "/ppm-evaluations", icon: Microscope },
    ]
  },
  {
    section: "Configuration",
    items: [
      { name: "Scoring Rules", href: "/configurations", icon: Settings },
    ]
  }
];
